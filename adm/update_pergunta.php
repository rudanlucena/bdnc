                    ...
                    <div class="col-md-12">
                            ...
                            <?php
                                include("../conexao.php"); 
                                            ...
                                            $sql ="UPDATE pergunta set pergunta ='$pergunta' where id='$id'";
                                                        $result = mysqli_query( $db, $sql);
                                                         if(!$result){
                                                              ?>
                                                              <div class="alert alert-danger">
                                                                      <strong>Error!</strong> não foi possivel atualizar a pergunta.
                                                             ...
                                                             <div class="alert alert-success">
                                                                       <strong>Success!</strong>Pergunta atualizada com sucesso.
